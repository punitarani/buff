...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_work_citations_id'), 'work_citations', ['id'], unique=False)
    op.create_table('work_references',
    sa.Column('id', sa.Text(), nullable=False),
    sa.Column('work_id', sa.Text(), nullable=False),
    ...
    op.create_index(op.f('ix_work_references_id'), 'work_references', ['id'], unique=False)
